...
**بقي من M6:** المُقرِّر النهائي كمرحلة نموذجية كاملة (مخطّط مطبوع، وحلقة أدوات موصولة، وأدلة بصرية)،
وربط `PipelineLedger` بجدول `agent_traces`، وكتابة `prompt_hash` عند نقطة الحفظ.
