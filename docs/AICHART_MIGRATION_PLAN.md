...
**متبقٍّ من M0:** منصّة المرجع الذهبي + `docs/PORTING.md`، وسقالة i18n في الواجهة، وملفات ADR،
وتوسيع `OHLCBar` بـ `ts`/`volume` والتحويل إلى `float`، وتحديث `LEOVEE_SPEC.md` بالانحرافات.
