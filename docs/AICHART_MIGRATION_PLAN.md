...
**بقي إلى M9:** `toDrawings.ts` (جسر الرسم الدلالي)، و`rectangles` و`cupHandle` و`flags` — ثلاثة
قوالب إضافية لا يعتمد عليها أي سطح حالي، وتُضاف داخل نفس المايسترو بلا تغيير في العقد.
