...
|---|---|---|
| القراءة والتحليل (شموع، مؤشرات، بنية، هندسة، سيولة، مناطق، ذاكرة، توصيات، إحصاءات) | ✅ أُعيد بناؤها في السجل الموحّد (**34 أداة** + 4 أسماء بديلة قديمة؛ أرضية العدّ تُفرض باختبار مطابقة) | — |
