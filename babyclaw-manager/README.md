...
`OMNIROUTE_API_KEY` اختياري في هذا النشر (`REQUIRE_API_KEY=false`). اتركه فارغاً. إن احتجته لاحقاً يُنشأ من لوحة OmniRoute المحلية (`http://127.0.0.1:20128` عبر نفق SSH) من صفحة API Keys / Endpoints، وليس من موقع OpenAI.
